...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('account_userprofile', (
            ...
            ('evernote_token', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('evernote_token_expires_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
